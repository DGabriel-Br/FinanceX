...
export const Sidebar = ({ 
  ...
  return (
    <aside className={cn(
      "hidden md:flex bg-sidebar text-sidebar-foreground flex-col transition-[width] duration-300 ease-in-out relative h-screen sticky top-0",
      ...
      <div className="px-4 pt-6 pb-6 flex justify-center">
        ...
        <div className="relative flex items-end flex-shrink-0 group">
          ...
          {!collapsed && (
            <span 
              className="text-2xl font-black tracking-wider text-white relative drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]"
